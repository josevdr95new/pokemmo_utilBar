...
"C:\Program Files (x86)\VisualNeoWin\VisualNeoWin.exe" /C "%~d0%~p0PokemmoUtilBar.pub"
...
REM "C:\Program Files (x86)\VisualNeoWin\VisualNeoWin.exe" "%~d0%~p0PokemmoUtilBar.pub"
